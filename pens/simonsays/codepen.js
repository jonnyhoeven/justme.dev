...
function SimonGame(gridContainerID,scoreContainerID) {
    ...
    function Grid(container, presets, animationTypes, size, iconSize) {
        this.items = [];
        ...
        function Item(itemID, preset, container, animationTypes) {
            ...
            this.animate = function (animationTypeIndex) {
                ...
                this.icon.classList.add(animationTypes.animations[animationTypeIndex]); // add animation class
        ...
        // create grid items
        for (var itemID = 0, colCount = 0; itemID < size * size; itemID++) {
            colCount++;
    ...
    function Manager(sequence, grid, animationTypes, scoreContainer) {
        ...
        function correctValue(id) {
            if (sequence.underMaxSequenceLength()) {

            } else if (sequence.itemsRemaining()) {
                sequence.next();
            } else {
    ...
    this.reset = function () {
        ...
        this.grid = new Grid(this.gridContainer, this.presets, this.animationTypes, this.size, this.iconSize);
