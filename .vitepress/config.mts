    ...
    head: [
      ...
      [
        'link',
        {
          ...
          color: SITE_CONSTANTS.IMAGES.FAVICON_MASK_COLOR
        }
      ],
      [
        'meta',
        {
          ...
          content: SITE_CONSTANTS.SITE_NAME
        }
      ],
      ...
      [
        'meta',
        {
          ...
          content: SITE_CONSTANTS.IMAGES.FAVICON_MASK_COLOR
        }
      ],
      [
        'meta',
        { name: 'theme-color', content: SITE_CONSTANTS.IMAGES.THEME_COLOR }
      ]
    ],
    transformHead: ({ pageData }) => {
      ...
      head.push([
        'meta',
        {
          name: 'title',
          property: 'og:title',
          content: pf.title ? pf.title : 'Just make it!'
        }
      ]);
      head.push([
        'meta',
      ...
      head.push([
        'meta',
        { name: 'keywords', content: SITE_CONSTANTS.KEYWORDS }
      ]);
      head.push([
        'meta',
        {
